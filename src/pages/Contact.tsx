  ...
  const contactOptions = [
    {
      ...
      email: "hello@thesynlab.com",
      address: "123 Tech Innovation Drive, Suite 401, San Francisco, CA 94105"
    },
    {
      icon: MapPin,
      title: "Office Address",
      description: "Our registered business address",
      email: "legal@thesynlab.com",
      address: "123 Tech Innovation Drive, Suite 401, San Francisco, CA 94105, United States"
    },
    {
      icon: Newspaper,
      title: "Press & Media",
      description: "Media inquiries, interview requests, and press releases",
      email: "press@thesynlab.com",
    },
    {
      icon: Building,
      title: "Business & Partnerships",
      description: "Advertising, sponsorships, and collaboration opportunities",
      email: "partners@thesynlab.com",
    },
  ];
