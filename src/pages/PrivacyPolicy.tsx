...
To exercise these rights, please contact us at privacy@thesynlab.com or use the "Cookie Settings" button at the bottom of our site.`
    },
    {
      icon: Settings,
...
Email: privacy@thesynlab.com
Address: TheSynLab Media Group, Rudi-Dutschke-Straße 26, 10969 Berlin, Germany
...
We retain your personal data only for as long as necessary to fulfill the purposes described in this policy. When data is no longer needed, we securely delete or anonymize it. To request deletion of your data, email privacy@thesynlab.com with the subject "Data Deletion Request." We will confirm deletion within 30 days.`
    }
  ];
